...
export default function SignupPage() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-zinc-50 p-4 font-sans">
            <div className="w-full max-w-[420px] bg-white rounded-3xl shadow-xl p-8 relative mt-12 mb-12">
                ...
                <div className="mt-8 text-center space-y-2 mb-8">
                    ...
                    <p className="text-gray-500 text-sm">Join <span className="text-brand-red font-semibold">MyValue</span> to evaluate your business</p>
                </div>
